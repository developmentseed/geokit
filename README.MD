...
This funcionality will filter features by geometry and will generate a new geojson file with the filtered objects.

 ```
geokit filterbygeo <input.geojson> --type type=Polygon > output.geojson
 ```
