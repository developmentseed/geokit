...
### [geojsplit](https://github.com/woodb/geojsplit)

- Splits up a GeoJSON file into smaller GeoJSON files.

```
geojsplit --geometry-count 1000 --suffix-length 1 --output-directory output_files/ input.geojson
```
