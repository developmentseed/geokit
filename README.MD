...
- Fixes ordinal suffixes of the addresses.

```
 geokit fixordinal input.osm output.osm

```

### Add random id

- Adds a random id per each feature.

```
 geokit addrandomid input.osm output.osm
...
```
 geokit fixospoints input.osm output.osm
